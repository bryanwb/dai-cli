...
'\\______ \\ _____  |__|          /   _____/|  |__   ____ |  | |  |  \n' +
' |     |  \\__  \\ |  |  ______  \\_____  \\ |  |  \\_/ __ \\|  | |  |  \n' +
' |     `  \\/ __ \\|  | /_____/  /        \\|   Y  \   ___/|  |_|  |__\n' +
' /______  (____  /__|         /_______  /|___|  /\\___  >____/____/\n' +
'        \\/     \\/                     \\/      \\/     \\/           \n';


  
  console.log(chalk.green(splash));
  console.log(chalk.green('\tWelcome to dai-shell! Your gateway to exploring DAI and MakerDAO'));
  ...
  console.log(chalk.green(`You're all set! Rock on with your bad self`));
}
